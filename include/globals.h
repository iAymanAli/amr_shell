...
// A struct that stores information for the complete builtin command
typedef struct {
    bool populated;
    char cmd[255];
    char flag[4];
...
// Determine the path delimiter and path separator for Unix based systems
...
extern char *commands_arr[4 * KB];  // Global array storing built-in commands names and programs names from PATH
